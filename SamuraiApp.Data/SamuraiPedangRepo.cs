...
{
    public class SamuraiPedangRepo : ISamuraiPedang
    {
        private SamuraiContext _context;
        public SamuraiPedangRepo(SamuraiContext context)
        {
            _context = context;
        }
        ...
        {
            var result = await _context.Samurais.Include(e => e.Pedangs).FirstOrDefaultAsync(s => s.Id == id);
